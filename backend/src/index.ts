...
app.patch('/api/users/:id', usersRouter);
app.use('/api/jobs', jobsRouter);
app.patch('/api/jobs/:id', jobsRouter);
app.use('/api/candidates', candidatesRouter);
app.patch('/api/candidates/:id', candidatesRouter);
app.put('/api/candidates/:id/status', candidatesRouter);
